...
@:keep @:bind @:noCompletion #if display private #end class __ASSET__assets_sounds_plip_ogg extends null { }
@:keep @:bind @:noCompletion #if display private #end class __ASSET__assets_sounds_kaboom_ogg extends null { }
...
@:keep @:file("assets/sounds/plip.ogg") @:noCompletion #if display private #end class __ASSET__assets_sounds_plip_ogg extends haxe.io.Bytes {}
@:keep @:file("assets/sounds/kaboom.ogg") @:noCompletion #if display private #end class __ASSET__assets_sounds_kaboom_ogg extends haxe.io.Bytes {}
