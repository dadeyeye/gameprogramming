...
class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("FlxPongApi", create);

		#if (js && html5)
		#if (munit || utest)
		lime.system.System.embed("FlxPongApi", null, 900, 300);
		#end
		#else
		create(null);
		#end
	...
	public static function create(config):Void
	{
		...
		app.meta["file"] = "FlxPongApi";
		app.meta["name"] = "FlxPongApi";
